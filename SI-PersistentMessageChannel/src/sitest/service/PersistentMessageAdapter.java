...
/**
 * The PersistentMessageAdapter is a service that handles saving and retrieving
 * messages from a {@link MessageDao}. It offers a single method for saving
 * messages and a single method for removing and returning the next message. It
 * also has a method for handling messages that failed.
 */
