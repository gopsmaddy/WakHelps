...
/**
 * This is the implementation of the {@link IntegrationMessageDaoAdapter}. This
 * handles a single configured queue of messages.
 */
public class IntegrationMessageDaoAdapterImpl implements
    IntegrationMessageDaoAdapter
{
  ...
  private static Logger sLog =
      Logger.getLogger(IntegrationMessageDaoAdapterImpl.class);
  ...
  /*
   * (non-Javadoc)
   * @seesitest.service.IntegrationMessageDaoAdapter#save(org.springframework.
  ...
  /*
   * (non-Javadoc)
   * @see sitest.service.IntegrationMessageDaoAdapter#removeNext()
   */
  ...
  /*
   * (non-Javadoc)
   * @seesitest.service.IntegrationMessageDaoAdapter#handleFailedMessage(org.
   * springframework.integration.core.Message)
   */
