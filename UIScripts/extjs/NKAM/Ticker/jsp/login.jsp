              ...
              <h:panelGrid columns="3"
                  ...
                  <f:verbatim></f:verbatim>
                      ...
                      <h:panelGrid columns="1"
                              ...
                              <h:panelGrid columns="3"
                                  ...
                                  <h:panelGrid columns="3"
                                      ...
                                      <c:if test="${not empty param['retry']}">
                                          <f:verbatim>
                                               <tr align="center">
                                                    <td colspan = "3" ><b>Login incorrect.  Please try again.</b></td>
                                               </tr>
                                          </f:verbatim>
                                      </c:if>
                          ...
                          <h:outputText value="Please login to access NSAM Operator Interface" escape="false" styleClass="text text-nowrap"/>
