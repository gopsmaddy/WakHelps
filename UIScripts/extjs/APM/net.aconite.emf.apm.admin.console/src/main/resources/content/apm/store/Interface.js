var myInterfaceMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('Apm.store.Interface',
{
	extend		: 'Ext.data.Store',
	id			: 'idInterfaceStore',
	model		: 'Apm.model.Interface',
	remoteSort	: true,
