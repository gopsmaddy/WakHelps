var tokenAuditLogMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});
Ext.define('Apm.store.AuditLog',
{
	extend		: 'Ext.data.Store',
	id			: 'idAuditLogStore',
	model		: 'Apm.model.AuditLog',
	remoteSort	: true,
	...
	sorters: [{property: 'dateTime', direction: 'ASC'}]
});	
///////////////////////////////////////////////////