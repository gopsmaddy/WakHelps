var varEncryptionZoneMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('Apm.store.EncryptionZone', 
{
	extend		: 'Ext.data.Store',
	id			: 'idEncryptionZoneStore',
	model		: 'Apm.model.EncryptionZone',
	remoteSort	: true,
