var tokenOrderTypeMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});
Ext.define('Apm.store.TokenOrderType',
{
	extend		: 'Ext.data.Store',
	id			: 'idTokenOrderTypeStore',
	model		: 'Apm.model.TokenOrderType',
//	data   		:
//				[
//                    {"id":1, "name":"Active"},
//                    {"id":2, "name":"Inactive"},
