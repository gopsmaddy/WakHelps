var manageTokensMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});
Ext.define('Apm.store.ManageTokens',
{
	extend		: 'Ext.data.Store',
	id			: 'idManageTokensStore',
	model		: 'Apm.model.ManageTokens',
	remoteSort	: true,
