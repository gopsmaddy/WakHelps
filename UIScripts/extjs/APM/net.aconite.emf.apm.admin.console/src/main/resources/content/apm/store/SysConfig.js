var varSysConfigMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('Apm.store.SysConfig',
{
	extend		: 'Ext.data.Store',
	id			: 'idSysConfigStore',
	model		: 'Apm.model.SysConfig',
	remoteSort	: true,
