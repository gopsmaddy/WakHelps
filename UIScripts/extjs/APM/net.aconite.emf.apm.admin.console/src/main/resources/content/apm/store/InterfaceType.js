var myInterfaceTypeMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('Apm.store.InterfaceType',
{
	extend		: 'Ext.data.Store',
	id			: 'idInterfaceTypeStore',
	model		: 'Apm.model.InterfaceType',
	remoteSort	: true,
