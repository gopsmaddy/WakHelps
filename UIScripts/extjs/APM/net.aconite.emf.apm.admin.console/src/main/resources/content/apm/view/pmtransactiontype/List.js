...
Ext.define('Apm.view.pmtransactiontype.List' ,
{
    extend	: 'Ext.grid.Panel',
    alias 	: 'widget.pmtransactiontypelist',
	...
	id		: 'idPMTransactionTypeList',
    title 	: 'PMTransactionType List',
	store	: 'PMTransactionType',
	renderTo: 'divPMTransactionTypeList',
	hidden	: false,	
...
//			},
	...
	plugins: [varPMTransactionTypeCellEditing],
	//plugins: [rowEditing],
		
	dockedItems: 
	[
		{
			id 		: 'idPMTransactionTypeTBar',
			xtype	: 'apptoolbar',
			dock	: 'top',
			hidden	: false,
		},		
		{
			id 		: 'idPMTransactionTypeBBar',
			xtype	: 'apppagingbar',
			store	: 'PMTransactionType',
			dock	: 'bottom',
			hidden	: false,
