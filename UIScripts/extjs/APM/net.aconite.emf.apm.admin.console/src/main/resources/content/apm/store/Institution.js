var varInstitutionMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});

Ext.define('Apm.store.Institution',
{
	extend		: 'Ext.data.Store',
	id			: 'idInstitutionStore',
	model		: 'Apm.model.Institution',
	remoteSort	: true,
