var binrangeMask = new Ext.LoadMask(Ext.getBody(), {msg:"Please wait..."});
Ext.define('Apm.store.BINRange', 
{
	extend		: 'Ext.data.Store',
	id			: 'idBINRangeStore',
	model		: 'Apm.model.BINRange',
	remoteSort	: true,
	...
	sorters: [{property: 'binFrom', direction: 'ASC'}]
});	
///////////////////////////////////////////////////