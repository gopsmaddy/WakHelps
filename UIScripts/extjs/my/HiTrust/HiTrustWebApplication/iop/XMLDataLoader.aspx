<%@ Page language="C#" ContentType="text/xml"  Inherits="FundWorks.Web.Library.AuthenticatedPage" %>

<%@ IMPORT namespace="System" %> 
<%@ IMPORT namespace="System.IO" %>
<%@ IMPORT namespace="System.Net" %>
<%@ IMPORT namespace="System.Text" %>
<%@ IMPORT namespace="FundWorks.Web.Library" %>
...
{ 	
	try
	{
		...
		string user = webUser.Username;
		string pass = webUser.Entity.GetAttributeValue("hiTrustKey").Value.ToString();
