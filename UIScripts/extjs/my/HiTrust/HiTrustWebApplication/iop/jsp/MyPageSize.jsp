...
<%
		...
		String orgXMLFile = serverContextURL+"iop/xml/MyPageSize.xml";
		String orgXSLFile = serverContextURL+"iop/xsl/MyPageSize.xsl";
		
		//String orgXMLFile = "http://localhost:8080/HiTrustWebApplication/iop/xml/MyPageSize.xml";
		//String orgXSLFile = "http://localhost:8080/HiTrustWebApplication/iop/xsl/MyPageSize.xsl";
